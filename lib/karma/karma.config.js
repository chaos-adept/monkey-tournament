...
commonConfig.root.push(path.resolve(__dirname, './lib/karma'));
...
var karmaEntryPointPath = './lib/karma/karma-entry.js';
// var karmaEntryPointPath = {pattern: './lib/**/__tests__/*--spec.js', watched: false};//'./lib/karma/karma-entry.js';
...
module.exports = function (config) {
    ...
    if (isCoverageEnabled) {
        ...
        karmaConigProps.instrumenterOptions = {
            istanbul: {
                noCompact:true,
                embedSource: true,
                noAutoWrap: true
