...
export class EnterAttemptDialog extends React.Component {
    ...
    onChangeClan = (e, clanName) => {
        localStorage.lastClanName = clanName;
    ...
    onAttempt() {
        ...
        this.props.onAttempt(value, this.state.clan);
    }
    ...
    render() {
        ...
        >
            ...
            <TextField name="attempt-clan-input" onChange={this.onChangeClan} hintText="clan name" type="text" value={this.state.clan}/>
        </Dialog>
    }
