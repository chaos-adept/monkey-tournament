...
export class Play extends React.Component {
    ...
    handleOpen = () => {
        ...
        this.setState({open: true, attemptSessionId: moment().format('YYYY-MM-DD--mm-hh')});
    };
    ...
    handleAccelSensorData(data) {
        console.log('sensor data', data);
        data.sessionId = this.state.attemptSessionId;
        this.socket.emit('accelSensorData', data);
    }
                ...
                {auth && <div>
...

                    {
                        ...
                        <span data-sid="enter-attempt-dlg">
                            <EnterAttemptDialog onAccelSensorData={(data) => this.handleAccelSensorData(data)} open={this.state.open} handleClose={() => this.handleClose()}
