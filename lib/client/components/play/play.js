            ...
            <div>
                <div>
                    {!auth && (<div className="alert alert-danger" role="alert"> user is not auth
                        <div>
                            <Link to="/login"><button className="btn btn-default" data-sid="auth-failed-login-btn">login</button></Link>
                        </div>
                    </div>)}
                </div>
                ...
                {auth && <div>
                    ...
                    <div className="row">
                        <div className="col-xs-12 col-md-8">
                            ...
                            <div className="col-xs-12 col-md-8">
                                {(todayScores && <Scores data={todayScores} prevData={yesterdayScores}/>) || 'None'}
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-xs-12 col-md-8">
                            ...
                            <div className="col-xs-12 col-md-8">
                                {(yesterdayScores && <Scores data={yesterdayScores} prevData={twoDaysAgoScores}/>) || 'None'}
                            </div>
                        </div>
                    </div>
                    <div className="row">
