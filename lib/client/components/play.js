                                ...
                                <div className="col-xs-12 col-md-8" id="profile">
                                    {
                                        player &&
                                        (<span>
                                        {player.photos.map(it => <img className="img-circle" src={it.value}/>)}
                                        ...
                                        <li className="media">
                                            <div className="media-left media-middle">
                                                <div className="media-object">
                                                    <div>
                                                        {it.player.photos.map(photo => <img className="img-circle"
                                                                                            src={photo.value}/>)}</div>
                                                </div>
                                            </div>
                                            <div className="media-body">
                                                <h4 className="media-heading"><span className="badge">{it.score}</span>
                                                </h4>
