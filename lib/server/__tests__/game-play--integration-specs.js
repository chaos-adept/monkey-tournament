...
const enterAttempt = async (driver, value) => {
    driver.wait(until.elementIsVisible(driver.findElement(By.css(`[data-sid='add-attempt-btn']`))));
...
describe("Integration login actions", () => {
    ...
    it("should login players over vk", async () => {
        ...
        driver.wait(until.elementIsVisible(resultListEl));
    });
    ...
    it("should log attempt", async () => {
        ...
        driver.wait(until.elementTextIs(driver.findElement(By.css(scoreElSelector)), '12'), 1000);
    });
